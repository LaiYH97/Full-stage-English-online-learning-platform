...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        //4.设置成功之后要跳转的链接
        bean.setSuccessUrl("/user/home.html");
        //5.设置未授权界面
        ...
        map.put("/auth/**", "anon");     
        map.put("/course/list.html*", "anon");
        map.put("/course/learn/*.html", "anon");
        map.put("/course/video/*.html", "authc");
        map.put("/courseComment/segment.html*", "anon");
        map.put("/**", "authc");
